...
.controller('IssueListCtrl', function($scope, $location, ScoreFactory){
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
          ...
          {field: 'references', displayName:'Refs', width: '4%', cellFilter: 'number:0'},
          {field: 'created', displayName: 'Created', width: '7%', cellFilter: 'date:"MM/dd/yyyy"'},
          {field: 'updated', displayName: 'Updated', width: '7%', cellFilter: 'date:"MM/dd/yyyy"'},
          ...
          {field: 'assignee', displayName: 'Assignee', width: '7%'},
          {field: 'milestone', displayName: 'MS', width: '4%'},
        ],
        multiSelect: false,
